...
(function() {
  ...
  getPreText = function(option, arg$, maxWidth) {
    ...
    mainName = option.option, shortNames = (ref$ = option.shortNames) != null ?
      ref$ : [], longNames = (ref$ = option.longNames) != null ?
      ref$ : [], type = option.type, description = option.description;
    ...
    names = mainName.length === 1 ? [mainName].concat(shortNames, longNames) :
  ...
  generateHelp = function(arg$) {
    ...
    return function(arg$) {
      ...
      ref$ = arg$ != null ?
        arg$ : {}, showHidden = ref$.showHidden, interpolate = ref$.interpolate;
      maxWidth = stdout != null && stdout.isTTY ? stdout.columns - 1 : null;
      output = [];
      out = function(it) {
